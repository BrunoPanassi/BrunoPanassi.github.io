...
function EndVideo()
{
    ...
    if (cena == 1)
    {
        document.getElementById('Video').src = '../static/Video/2_Scene.mp4'
...
function RedPill()
{
    document.getElementById('Track_Video').src = ''
    document.getElementById('Track_Video_EN').src = ''
    document.getElementById('Video').src = '../static/Video/Red_Pill_Scene.mp4'
...
function BluePill()
{
    document.getElementById('Track_Video').src = ''
    document.getElementById('Track_Video_EN').src = ''
    document.getElementById('Video').src = '../static/Video/Blue_Pill_Scene.mp4'
    document.getElementById('Video').muted = false
    document.body.removeChild(divButtons)
